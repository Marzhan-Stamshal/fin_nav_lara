...
<head>
    ...
    <title>{{ $title ?? 'Fin Navigation' }}</title>
    <style>
        ...
        *::after {
        ...
        body {
            ...
            color: #0f172a;
            background: linear-gradient(145deg, #e8efff, #dbeafe 46%, #c7d2fe);
            min-height: 100vh;
        }
...
<body>
        ...
        <div class="nav">
            <div class="nav-inner">
                <div class="nav-top">
                    ...
                    <button id="navToggle" class="nav-toggle" type="button" aria-expanded="false"
    ...
    <main class="{{ request()->routeIs('login') || request()->routeIs('register') ? '' : 'wrap' }}">
        @if (session('success'))
            <div class="success {{ request()->routeIs('login') || request()->routeIs('register') ? 'auth-card' : '' }}"
                style="margin:{{ request()->routeIs('login') || request()->routeIs('register') ? '12px auto' : '0 0 12px 0' }};">
                {{ session('success') }}</div>
        @endif
        @if ($errors->any())
            <div class="error {{ request()->routeIs('login') || request()->routeIs('register') ? 'auth-card' : '' }}"
                style="margin:{{ request()->routeIs('login') || request()->routeIs('register') ? '12px auto' : '0 0 12px 0' }};">
